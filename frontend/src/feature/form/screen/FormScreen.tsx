...
export default function FormScreen() {
    ...
    const { mutateAsync: submitFormMutation, isPending: isSubmitting } =
        useMutation({
    ...
    const handleNext = () => {
        ...
        if (activeStep === 0) {
            ...
            const agreementData: AgreementData = {
                agreement1: agreementForm.values.agreement1 as
                    | "agree"
                    | "disagree",
                agreement2: agreementForm.values.agreement2 as
                    | "agree"
                    | "disagree",
                agreement3: agreementForm.values.agreement3 as
                    | "agree"
                    | "disagree",
            };
            ...
            if (!agreementResult.success) {
                const errors = agreementResult.error.issues.map(
                    (issue) => issue.message,
                );
                ...
                notifications.show({
                    ...
                    message:
                        "Mohon periksa dan lengkapi semua persetujuan yang diperlukan.",
                    color: "red",
            ...
            const personalInfoData: PersonalInfoData = {
                ...
                jenis_kelamin: personalInfoForm.values.jenis_kelamin as
                    | "L"
                    | "P",
            ...
            const personalInfoResult =
                personalInfoSchema.safeParse(personalInfoData);
            if (!personalInfoResult.success) {
                const errors = personalInfoResult.error.issues.map(
                    (issue) => issue.message,
                );
                setValidationErrors(errors);
                ...
                notifications.show({
                    title: "Validasi Gagal",
                    message:
                        "Mohon periksa dan perbaiki kesalahan pada formulir.",
                    color: "red",
                    icon: <IconExclamationMark size={16} />,
                });
                return;
    ...
    const handleSubmit = async () => {
        ...
        if (!turnstileToken) {
            ...
            notifications.show({
                ...
                message:
                    "Mohon selesaikan verifikasi keamanan terlebih dahulu.",
                color: "red",
                icon: <IconExclamationMark size={16} />,
            });
            return;
        ...
        if (agreementValidation.hasErrors || personalInfoValidation.hasErrors) {
            ...
            const allErrors = [
                ...Object.values(agreementValidation.errors)
                    .filter(Boolean)
                    .map(String),
                ...Object.values(personalInfoValidation.errors)
                    .filter(Boolean)
                    .map(String),
            ];
        ...
        return (
            ...
            >
                <Stack gap="lg">
                    ...
                    <Transition
                        mounted={validationErrors.length > 0}
                        transition="fade"
                        duration={200}
                    >
                        {(styles) => (
                            ...
                            <Stack align="center" gap="xl">
                                ...
                                <Stack align="center" gap="sm">
                                    ...
                                    <Text size="sm" c="dimmed" ta="center">
                                        Sedang memproses data Anda, mohon tunggu
                                        sebentar...
                                    </Text>
                                    <Progress
                                        value={65}
                                ...
                                >
                                    <Text size="sm" ta="center">
                                        Jangan tutup halaman ini sampai proses
                                        selesai
                                    </Text>
                                </Alert>
                            </Stack>
                    ...
                    >
                        <Stack gap="sm">
                            ...
                            <Text size="xs" c="dimmed">
                                Mohon selesaikan verifikasi keamanan di bawah
                                ini sebelum mengirim formulir
                            </Text>
                            <Center>
                                <TurnstileWidget
                                    ref={turnstileRef}
